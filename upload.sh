...
git add .
git status
git commit -m 'auto update Cpp'
echo '--------commit successfully--------'

git push -f https://github.com/Shuaiwen-Cui/Skillsets-Cpp.git main
# git push -u https://github.com/Shuaiwen-Cui/Skillsets-Cpp.git
# git remote add origin https://github.com/Shuaiwen-Cui/Skillsets-Cpp.git
